...
| <a name="output_datastore_kms_key_s3_arn"></a> [datastore\_kms\_key\_s3\_arn](#output\_datastore\_kms\_key\_s3\_arn) | The ARN of the KMS key used to encrypt and decrypt the S3 bucket |
